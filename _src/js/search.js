...
// NOTE: Creating the search box/form
...
// NOTE: Navigating between the search box options
...
// NOTE: Creating the search engine index
...
function indexCreate() {
    ...
    for (e in eng) {
        ...
        $(".engines").prepend("<a id='" + e + "_logo' ref='" + e + "'><img src='img/engines/" + eng[e].logo + "'></a>");
...
function indexClose() {
    ...
    // NOTE: Because jQuery doesn't like me
